                ...
                <div className="border-r p-3 flex flex-col  h-full">
                    <div className="flex-1">
                        ...
                        <ul className="text-xs mt-2">
                            <li className="py-1 text-foreground/60">
                                Base Icon
                            </li>
                            {layersArray.map((item, index) => (
                                <li
                                    key={index}
                                    className="flex w-full justify-between text-foreground/60"
                                >
                                    Layer {item.id}
                                    <button
                                        onClick={() => toggleVisibilty(item.id)}
                                    >
                                        {item.visible === true ? (
